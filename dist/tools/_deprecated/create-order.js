...
function warnOnce() {
    ...
    console.warn("[@semore/mcp-commerce] create_order is DEPRECATED (ADR-0062). " +
...
export const createOrderTool = {
    name: "create_order",
    description: "[DEPRECATED — use submit_intent] Convert a priced cart into an order. Returns a checkout URL for payment.",
